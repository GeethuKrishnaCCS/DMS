...
export class DMSService extends BaseService {
    ...
    public getByIdSelect(siteUrl: string, listname: string, itemid: any, select: string): Promise<any> {
    ...
    public getItemSelectFilter(siteUrl: string, listname: string, select: string, filter: string): Promise<any> {
        return this._spfi.web.getList(siteUrl + "/Lists/" + listname).items.select(select).filter(filter)();
    }
    ...
    public getItemSelectExpand(siteUrl: string, listname: string, select: string, expand: string) {
        return this._spfi.web.getList(siteUrl + "/Lists/" + listname).items
            .select(select)
            .expand(expand)()
    }
    public getByIdSelectExpand(siteUrl: string, listname: string, headerId: any, select: string, expand: string) {
        return this._spfi.web.getList(siteUrl + "/Lists/" + listname).items
            .getById(headerId)
            .select(select)
            .expand(expand)()
